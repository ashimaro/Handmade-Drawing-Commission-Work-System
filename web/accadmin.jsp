                ...
                <div class="row">
                    <div class="col-md-4 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                            <img class="rounded-circle mt-5" src="https://previews.123rf.com/images/koblizeek/koblizeek2001/koblizeek200100050/138262629-man-icon-profile-member-user-perconal-symbol-vector-on-white-isolated-background-.jpg" width="100">
                            <span class="font-weight-bold"><strong>Hi, <%=user.getName()%></strong></span></div>
                    </div> 
                    <div class="col-md-8">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" name="name" value="<%=user.getName()%>">
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Password" name="password" value="<%=user.getPassword() %>">
                                </div>
                                <div class="col-md-6">
                                    <label>Address</label>
                                    <input type="text" class="form-control" placeholder="Address" name="address" value="<%=user.getAddress()%>">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <label>Postcode</label>
                                    <input type="text" class="form-control" placeholder="Postcode" name="postcode" value="<%=user.getPostcode()%>">
                                </div>
                                <div class="col-md-6">
                                    <label>City</label>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <label>State</label>
                                    <input type="text" class="form-control" placeholder="State" name="state" value="<%=user.getState()%>">
                                </div>
                                <div class="col-md-6">
                                    <label>Phone No</label>
                                    <input type="text" class="form-control" placeholder="Phone Number" name="phoneNo" value="<%=user.getPhoneNo()%>" >
                                </div>
                            </div>
                                <input type="hidden"  class="form-control" name="userId" value="<%=user.getUserId()%>">

                             <div class="mt-5 text-right"><div id="success"><button class="btn btn-primary profile-button" type="submit" name="action" value='updateadmin' onclick=success()  >Save</button></div></div>
                            </form>
                        </div>
