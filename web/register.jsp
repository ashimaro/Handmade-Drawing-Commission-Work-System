    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Welcome to HDCW!</h2>
                    <h3 class="title">We want to know more about you!</h3>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="postcode" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                           ...
                           <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="phoneNo" required>
                                </div>
                            </div>
                        </div>
                        <a href="index.jsp">Click here to login.</a>
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit" id = "login" name='login' value ='login'>Login</button>
                            <button class="btn btn--radius-2 btn--blue" type="submit" id = "register"  name='action' value ='register'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
