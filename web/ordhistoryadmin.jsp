...
<html lang="en">
    <head>
        ...
        <title>HDCW - Order History [ADMIN]</title>
        ...
        <div>
            <div class="p-12 grid grid-cols-12 sm:grid-cols-12 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-6 gap-6">
                <%
                    ...
                    List<commissionWork> listcommissionwork = commissionDAO.getAllcommissionWork(userId);
                    for (commissionWork commissionWork : listcommissionwork) {
                        user = userDAO.retrieveUserByUserId(commissionWork.getUserId());
                %>
                ...
                <div class="bg-gray-100 rounded-3xl overflow-hidden shadow-lg">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="product-option-shop">
                            <a class="add_to_cart_button"  href="viewcommission.jsp?id=<%=commissionWork.getCommissionId()%>">See More</a>
                        </div>                       
                    </div>
                </div>
                <%;
